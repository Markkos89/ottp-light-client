  ...
  return (
    <main className="flex flex-col items-start justify-center px-4 py-8">
      ...
      <p className="mb-4">
        ...
        <br />- Own your collaboration graph, forever.
      </p>
      <p className="mb-4">
        We’re on a mission to democratize innovation.
        <br />
        No degree required. Just pure value creation.
      </p>

      <div className="mb-8">
        <Link href="/attest" className="text-blue-600 hover:underline">
          Own Your Graph
        </Link>
      ...
      <div className="mb-8">
        ...
        <p>
          - Interested in building this open-source project together? Join us!
        </p>
      </div>
      ...
      <div className="mb-8">
        ...
        <p>
          - Create the future of work onchain using the OTTP SDK. What will you
          build?
        </p>
      </div>
